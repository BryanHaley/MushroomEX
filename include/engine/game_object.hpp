...
#define GOBJ_FLAG_HAS_COLL    0b00000100  // Indicates if the gobj has collision.
#define GOBJ_FLAG_SURFACE     0b00001000  // Indicates if the gobj uses collision surfaces or a cylinder.
#define GOBJ_FLAG_UNUSED3     0b00010000  // Currently unusued flag.
